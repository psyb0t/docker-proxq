...
type Config struct {
	...
	MaxBodySize          int64  `default:"10485760"             env:"PROXQ_MAX_REQUEST_BODY_SIZE"`  //nolint:lll
	DirectProxyThreshold int64  `default:"10485760"             env:"PROXQ_DIRECT_PROXY_THRESHOLD"` //nolint:lll
	DirectProxyPaths     string `env:"PROXQ_DIRECT_PROXY_PATHS"`                                    //nolint:lll
	...
	ListenAddress string `default:"127.0.0.1:8080" env:"PROXQ_LISTENADDRESS"`
}
